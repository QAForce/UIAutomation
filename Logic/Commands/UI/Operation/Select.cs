...
namespace Logic.Commands
{
    ...
    {
        public Select(String id, String description, KeyValuePair<String, Tuple<Type, String>> output, Dictionary<String, Tuple<Type, String>> parameters)
        ...
        public override void Run(TestContainer container)
        {
            try
            {
                ...
                SelectElement select = new SelectElement(elem.FindElement(by));
                select.SelectByText(base.GetParameter("Value"));
