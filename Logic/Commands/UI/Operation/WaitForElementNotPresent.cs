...
{
    [Serializable]
    public class WaitForElementNotPresent : Command
    {
        public WaitForElementNotPresent(String id, String description, KeyValuePair<String, Tuple<Type, String>> output, Dictionary<String, Tuple<Type, String>> parameters)
