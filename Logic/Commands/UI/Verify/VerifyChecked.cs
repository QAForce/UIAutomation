...
{
    public class VerifyChecked:Command
    {
        public VerifyChecked(String id, String description, KeyValuePair<String, Tuple<Type, String>> output, Dictionary<String, Tuple<Type, String>> parameters)
