...
{
    public class VerifyElementNotPresent:Command
    {
        public VerifyElementNotPresent(String id, String description, KeyValuePair<String, Tuple<Type, String>> output, Dictionary<String, Tuple<Type, String>> parameters)
