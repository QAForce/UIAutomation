...
{
    public class VerifyEnabled:Command
    {
        public VerifyEnabled(String id, String description, KeyValuePair<String, Tuple<Type, String>> output, Dictionary<String, Tuple<Type, String>> parameters)
        ...
        public override void Run(TestContainer container)
        {
            try
            {
                ...
                IWebElement btn = container.Driver.FindElement(by);
                ...
                if (!this.PassTest)
                {
                    ...
                    Logging.SaveLog("CommandId:" + this.Id + "=>Expecte value:Enabled" + "   Actual value:Disabled", ELogType.Info);
                }
