...
{
    public class VerifyTagNotPresent : Command
    {
        public VerifyTagNotPresent(String id, String description, KeyValuePair<String, Tuple<Type, String>> output, Dictionary<String, Tuple<Type, String>> parameters)
