...
{
    public class VerifyDisabled:Command
    {
        public VerifyDisabled(String id, String description, KeyValuePair<String, Tuple<Type, String>> output, Dictionary<String, Tuple<Type, String>> parameters)
        ...
        public override void Run(TestContainer container)
        {
            try
            {
                ...
                IWebElement btn = element.FindElement(by);
                ...
                if (!this.PassTest)
                {
                    ...
                    Logging.SaveLog("CommandId:" + this.Id + "=>Expecte value:Disabled" + "   Actual value:Enabled", ELogType.Info);
                }
