...
{
    public class VerifyElementHeight : Command
    {
        public VerifyElementHeight(String id, String description, KeyValuePair<String, Tuple<Type, String>> output, Dictionary<String, Tuple<Type, String>> parameters)
        ...
        public override void Run(TestContainer container)
        {
            try
            {
                ...
                Size elem = element.FindElement(by).Size;

                if (base.GetParameter("Value").Equals(elem.Height.ToString()))
                {
                    /// TODO: Pass
                    this.PassTest = true;
                }
                ...
                if (!this.PassTest)
                {
                    ...
                    Logging.SaveLog("CommandId:" + this.Id + "=>Expecte value:" + base.GetParameter("Value") + "   Actual value:" + elem.Height.ToString(), ELogType.Info);
                }
