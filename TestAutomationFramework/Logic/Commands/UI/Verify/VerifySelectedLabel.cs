...
{
    [Serializable]
    public class VerifySelectedLabel:Command
    {
        public VerifySelectedLabel(String id, String description, KeyValuePair<String, Tuple<Type, String>> output, Dictionary<String, Tuple<Type, String>> parameters)
        ...
        public override void Run(TestContainer container)
        {
            try
            {
                ...
                if (base.GetParameter("Value").Equals(selectElement.SelectedOption.Text))
                {
                    /// TODO: Pass     
                    this.PassTest = true;
                }
                ...
                if (!this.PassTest)
                {
                    ...
                    Logging.SaveLog("CommandId:" + this.Id + "=>Expecte value:" + base.GetParameter("Value") + "   Actual value:" + selectElement.SelectedOption.Text, ELogType.Info);
                }
